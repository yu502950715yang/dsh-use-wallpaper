...
export function alternateLoopbackOrigin(loc: WebFrameLocation): string | null {
...
export function webFrameSpec(wallpaperPath: string, loc: WebFrameLocation, altOrigin: string | null): WebFrameSpec {
