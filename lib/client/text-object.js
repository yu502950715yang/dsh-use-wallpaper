...
export function measureTextLayout(text, opts = {}) {
...
export function textCanvasSize(text, opts = {}) {
...
export function textAlignments(horizontalAlign, verticalAlign, alignment) {
...
export function textLayerOffset(layout, horizontalAlign, verticalAlign, alignment, scale) {
