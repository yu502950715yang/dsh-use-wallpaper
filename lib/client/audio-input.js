...
const gestureArmedContexts = new WeakSet();
...
function armGestureResume(context) {
    if (typeof window === 'undefined' || gestureArmedContexts.has(context))
        return;
...
export async function playWallpaperSound(url, analyzer) {
    try {
