...
import { createTextTexture, textCanvasSize, createClockDriver, createScriptDriver } from './text-object.js';
            ...
            try {
                ...
                for (const obj of desc.objects) {
                    ...
                    if (binding) {
                        ...
                        const scriptTexture = createTextTexture(scripted, opts);
                        textLayers.set(obj.id, {
                            texture: scriptTexture,
                            driver: createScriptDriver(scriptTexture.image, opts, binding, scripted),
                        });
                        continue;
                    }
